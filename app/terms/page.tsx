...
const sections = [
  ...
  { title: "Post-event data", body: "After an event ends organizers receive an connection summary summarizing registrations, check-ins, networking activity, and connections made. Guest personal data in reports may only be used for legitimate post-event follow-up and not for marketing without consent." },
