...
export const metadata: Metadata = {
  ...
  description: "Connect without the chase. Oreeti gives you a presence at events and full control over who sees it, when.",
  alternates: { canonical: "https://oreeti.com/attendees" },
  openGraph: {
    title: "Oreeti for Attendees — You Control the Room",
    description: "Event networking in East Africa — on your terms.",
