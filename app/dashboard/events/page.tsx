      ...
      <div style={{
        ...
        <div style={{display:"flex",justifyContent:"space-between",alignItems:"flex-start"}}>
          <div style={{flex:1,minWidth:0}} onClick={()=>router.push("/dashboard/events/"+event.id)}>
            ...
            <p style={{fontSize:"12px",color:"var(--text-tertiary)",margin:"0 0 2px"}}>📍 {event.venue}</p>
            <p style={{fontSize:"12px",color:"var(--text-tertiary)",margin:0}}>
              {new Date(event.start_time).toLocaleDateString("en-KE",{day:"numeric",month:"short",year:"numeric"})}
              {" · "}
              {new Date(event.start_time).toLocaleTimeString("en-KE",{hour:"2-digit",minute:"2-digit"})}
            </p>
          </div>
  ...
  return(
    <div style={{maxWidth:"600px",margin:"0 auto"}}>
      <div style={{display:"flex",justifyContent:"space-between",alignItems:"center",marginBottom:"20px"}}>
        ...
        <button onClick={()=>router.push("/dashboard/events/create")} style={{
