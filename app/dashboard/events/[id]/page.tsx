...
Event: ${event.title}
Venue: ${event.venue}
Date: ${new Date(event.start_time).toLocaleDateString("en-KE",{weekday:"long",day:"numeric",month:"long",year:"numeric"})}
...
NETWORKING
----------
Peak On Aura: ${stats.onAura}
Total Handshakes: ${stats.handshakes}
Profiles Unlocked: ${stats.unlocked}

Generated by Presence · ${new Date().toLocaleDateString("en-KE")}
    `.trim();
